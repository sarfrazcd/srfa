			...
			try:
				...
				if len(obj) == 1:
					listpass = [
						...
						obj[0]+'12345',
						obj[0]+'786', 'Pakistan',
						'786786','223344','1122334455',obj[0],
					...
					listpass = [
						...
						'786786','223344','112234455',					
					]
				elif len(obj) == 4:
					listpass = [
						obj[0]+obj[1],obj[0]+obj[1]+'123',obj[0]+obj[1]+'12345',obj[0]+' '+obj[1],obj[0]+'123', obj[0]+'12345',
						obj[1]+'123', obj[1]+'12345',
